import numpy as np
from research_1_libraries import get_timeseries, rsi, create_signals_random_contrarian, create_performance_columns
...
df = create_signals_random_contrarian(df, lower_barrier=40, upper_barrier=60)
